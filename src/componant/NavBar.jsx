      ...
      <nav className="container_nav_vertical">
        <div className="container_column">
          <img
            ...
            src="/src/assets/svg/logo_nav_zen.svg"
          />
          <img
            className="logo_nav_vertical"
            src="/src/assets/svg/logo_nav_swim.svg"
          />
          <img
            className="logo_nav_vertical"
            src="/src/assets/svg/logo_nav_bike.svg"
          />
          <img
            className="logo_nav_vertical"
            src="/src/assets/svg/logo_nav_pull_up.svg"
          />
        </div>
      ...
      <header className="container_nav_horizontal">
        <div className="container_row">
          <img
            ...
            src="/src/assets/svg/logo_nav_sport_see.svg"
            alt="SportSee"
          />
